        ...
        <div class="col-lg-11">
            <div class="card tab-content pt-2">
              <div class="tab-pane fade show active tambah desa" id="tambah-desa">
                <div class="card-body">
                <h5 class="card-title">Tambah Desa Kecamatan Bungursari</h5>
                ...
                <form action ="/adddesa" method="post">
                 @csrf
                    <div class="row mb-3">
                        <label for="kodewilayah" class="col-sm-2 col-form-label">Kode Desa</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <label for="url" class="col-sm-2 col-form-label">Lokasi Kantor Desa</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <label for="luaswil" class="col-sm-2 col-form-label">Luas Wilayah Desa (Km<sup>2</sup>) </label>
                        <div class="col-sm-10">
                  ...
                  <table class="table table-stripe table-sm">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Luas Wilayah Desa</th>
