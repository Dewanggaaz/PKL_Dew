...
<html lang="en">
  <head>
    ...
    <title>Login - Kecamatan Bungursari Kabupaten Purwakarta</title>
  ...
  <body class="text-center">
      <main class="form-signin w-100 m-auto bg-white">
        <form action="/login" method="post">
          @csrf
          <img class="mb-4" src="assets/img/logopwk.png" alt="" width="68" height="65">
          <h1 class="h6 mb-4 fw-bold">PEMERINTAHAHAN KABUPATEN PURWAKARTA <br> KECAMATAN Bungursari</h1>
